...
void main(void)
{
  ...
  filterTaps[0] = vec2(-0.326212, -0.405805)*bloomRadius;
  filterTaps[1] = vec2(-0.840144, -0.073580)*bloomRadius;
  filterTaps[2] = vec2(-0.695914,  0.457137)*bloomRadius;
  filterTaps[3] = vec2(-0.203345,  0.620716)*bloomRadius;
  filterTaps[4] = vec2( 0.962340, -0.194983)*bloomRadius;
  filterTaps[5] = vec2( 0.473434, -0.480026)*bloomRadius;    		  
